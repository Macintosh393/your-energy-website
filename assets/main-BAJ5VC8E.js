var _=Object.defineProperty;var D=(t,e,i)=>e in t?_(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var v=(t,e,i)=>D(t,typeof e!="symbol"?e+"":e,i);import{a as p,i as y}from"./vendor-XJ88ArH8.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function i(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=i(a);fetch(a.href,r)}})();const n={filter:"Muscles",filterValue:"",pagination:null};p.defaults.baseURL="https://your-energy.b.goit.study/api";async function z(){const t=await p.get(`/filters?filter=${n.filter}&page=${n.pagination.page}&limit=${n.pagination.perPage}`);return n.pagination.page===1&&n.pagination.setMaxPage(t.data.totalPages),t.data.results}async function J(t=""){const e=new URLSearchParams({page:n.pagination.page,limit:n.pagination.perPage});switch(t!=""&&e.set("keyword",t),n.filter){case"Muscles":e.set("muscles",n.filterValue);break;case"Body parts":e.set("bodypart",n.filterValue);break;case"Equipment":e.set("equipment",n.filterValue)}const i=await p.get(`/exercises?${e}`);return n.pagination.page===1&&n.pagination.setMaxPage(i.data.totalPages),i.data.results}async function H(t){return(await p.get(`/exercises/${t}`)).data}async function V(){return(await p.get("/quote")).data}async function U(t){try{await p.post("/subscription",{email:t}),y.success({title:"Success",message:"You are now subscribed",position:"bottomCenter"})}catch{y.error({title:"Error",message:"Couldn't subscribe. Email might be already registered",position:"bottomCenter"})}}async function j(t,e){await p.patch(`/exercises/${t}/rating`,e)}function o(t){return t.charAt(0).toUpperCase()+t.slice(1)}const Q=document.querySelector(".pagination-pages"),L=document.querySelector(".pagination-back-wrapper"),k=document.querySelector(".pagination-next-wrapper");function d(t,e){t===1?L.style.opacity="20%":L.style.opacity="100%",t===e?k.style.opacity="20%":k.style.opacity="100%";let i=[];for(let a=t-2;a<=t+2;a++)a>0&&a<=e&&i.push(a);let s=i.map(a=>`<li class="pagination-page-number ${a==t?"current":""}">${a}</li>`).join("");t<e-2&&(s+='<li class="pagination-page-number">...</li>'),Q.innerHTML=s}const G=document.querySelector(".content-list");async function l(t=""){const e=(await J(t)).map(i=>`
      ...
      </li>`).join("");G.innerHTML=e,d(n.pagination.page,n.pagination.maxPage)}let S;Z();function f(){return JSON.parse(localStorage.getItem("favorites"))??[]}async function W(t){const e=await H(t),i=f();console.log(i);const s=JSON.stringify([...i,e]);console.log(s),localStorage.setItem("favorites",s),K(t)}function M(t){const e=f(),i=JSON.stringify(e.filter(s=>s._id!=t));localStorage.setItem("favorites",i),X(t),n.pagination.purpose==="favorites"&&(n.pagination.updateSize(f().length),u())}function Y(t){return S.has(t)}function Z(){S=new Set(f().map(t=>t._id))}function K(t){S.add(t)}function X(t){S.delete(t)}const $=document.querySelector(".favorite-exercises-list"),ee=document.querySelector(".pagination");function u(){const t=f();if(t.length===0){$.innerHTML=`
    <li class="favorites-placeholder">
        ...
        like to your favorites for easier access in the future.
    </li>`,ee.style.display="none";return}$.innerHTML=t.slice((n.pagination.page-1)*n.pagination.perPage,n.pagination.page*n.pagination.perPage).map(e=>`
          <li class="exercise">
            <div class="exercise-line-wrapper">
                <span class="workout">workout</span>
                <div class="rating">
          ...
          </li>`).join("")}const te=document.querySelector(".content-list");async function g(){const t=(await z()).map(e=>`<li class="filter-tile" data-value="${e.name}" aria-label="${e.name}">
